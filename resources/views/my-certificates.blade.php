            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                @forelse ($certificates as $cert)
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition duration-300">
                        <div class="relative bg-slate-50 h-64 flex items-center justify-center border-b border-gray-100">
                            <div class="w-[86%] h-[78%] rounded-lg border-4 border-blue-100 bg-white shadow-inner px-8 py-6 text-center flex flex-col justify-center">
                                <p class="text-xs font-black text-blue-600 tracking-[0.25em] uppercase">Certificate</p>
                                <p class="mt-3 text-sm text-gray-500">Diberikan kepada</p>
                                <p class="mt-1 text-xl font-black text-gray-900">{{ Auth::user()->name }}</p>
                                <div class="mx-auto my-4 h-px w-24 bg-blue-200"></div>
                                <p class="text-sm font-bold text-gray-700">{{ $cert->title }}</p>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <span class="inline-flex items-center rounded-full bg-green-100 px-3 py-1 text-xs font-bold text-green-700">Selesai</span>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm text-gray-600 mb-6 bg-gray-50 p-3 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <span class="font-mono font-semibold text-gray-800">SC-{{ $cert->id }}-{{ Auth::id() }}</span>
                                </div>
                            </div>
